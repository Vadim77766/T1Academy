...
import ru.t1academy.autotests.uitests.task5.asserts.SelectAssert;
...
//        final String selenoidBrowserVersion = "127.0";
        ...
        driver = new RemoteWebDriver(new URL(selenoidUrl), caps, false);
    }
    ...
    public void testDropdown() {
        ...
        SelectAssert.assertThat(dropdown).hasSelectedOption(option);
        option = "Option 2";
        dropdown.selectByVisibleText(option);
        log.info("Dropdown text : {}", dropdown.getFirstSelectedOption().getText());
        SelectAssert.assertThat(dropdown).hasSelectedOption(option);
